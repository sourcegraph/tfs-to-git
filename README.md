...
- Workaround: Use git tfs like everyone else, even though it requires Windows, it can work with a username and password from an account with Code:Read permissions and a Project Reader role
